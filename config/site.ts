export const siteConfig = {
  name: "Nelson Bravo | Developer Portfolio Template",
  authorName: "Nelson Bravo",
  username: "NelsonBravo",
  description:
    "Nelson Bravo's portfolio - A modern, responsive Next.js portfolio for developers. This open-source template can be customized to showcase your own skills, projects, and professional experience.",
